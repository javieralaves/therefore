...
export const COPY = {
  ...
  CONTEXT_IMPROVE_BUTTON: "Improve my context",
  CONTEXT_CONNECTED_HANDLES: "Connected handles",
  CONTEXT_TOPICS: "Your topics",
  ...
  // Studio - Plan step
  PLAN_TITLE: "Let's plan your short",
  PLAN_SUMMARY_TITLE: "Plan summary",
  PLAN_SUMMARY_AUDIENCE: "Audience",
  PLAN_SUMMARY_ANGLE: "Angle",
  PLAN_SUMMARY_TONE: "Tone",
  ...
  SCRIPT_ACTION_TIGHTEN: "Tighten intro",
  ...
  MAKE_TIMELINE_CTA: "CTA",
  MAKE_TIMELINE_HOOK_DURATION: "3-5s",
  MAKE_TIMELINE_BODY_DURATION: "12-20s",
  MAKE_TIMELINE_CTA_DURATION: "3-5s",
  MAKE_AROLL_TITLE: "A-roll (you talking)",
  MAKE_AROLL_UPLOAD: "Upload clip",
  MAKE_AROLL_AI: "Use AI stand-in",
  MAKE_AROLL_RECORD_LATER: "Record later",
  MAKE_BROLL_TITLE: "B-roll (brand footage)",
  MAKE_CAPTIONS_AUTO: "Auto captions",
  ...
  PUBLISH_PLATFORM_INSTAGRAM: "Instagram Reels",
  PUBLISH_PLATFORM_TIKTOK: "TikTok",
  PUBLISH_PLATFORM_YOUTUBE: "YouTube Shorts",
  PUBLISH_CAPTION_LABEL: "Caption",
  ...
  // Placeholders
  PLACEHOLDER_EXAMPLE: "Example - Brand video",
  PLACEHOLDER_POST: "Recent post",
